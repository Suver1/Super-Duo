...
public class ScoresProvider extends ContentProvider
{
    ...
    public static final String SCORES_BY_DATE =
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
    {
        ...
        switch (match)
        {
            ...
            case MATCHES_WITH_DATE:
                    ...
                    //Log.e(LOG_TAG, SCORES_BY_DATE + " " + selectionArgs[0]);
    ...
    public int bulkInsert(Uri uri, ContentValues[] values)
    {
        ...
        switch (match_uri(uri))
        {
            case MATCHES:
                ...
                // When updated content is inserted to the db, the ContentProvider notifies the
                // ContentResolver about the changes with notifyChange(). ContentResolver then
                // notifies all registered observers which forces the observers to load new data.
